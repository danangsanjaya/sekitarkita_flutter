...
import 'package:sekitarkita_flutter/gui/screen/inputMacScreen.dart';
    ...
    return ListView(
      children: <Widget>[
        ...
        SwitchListTile(
          ...
          subtitle: Text("Layanan otomatis dijalankan saat anda membuka aplikasi."),
        ...
        builder: (context) {
          ...
          return NAlertDialog(
            ...
            content: Column(
              ...
              children: <Widget>[
                Text("Namamu hanya akan ditampilkan di aplikasi ini, ga akan dikasitau kesiapa-siapa"),
                ColumnDivider(),
                Text(
